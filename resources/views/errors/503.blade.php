...
@endsection
@section('description')
خطء 503.آسف, الخدمة غير متوفرة.الخدمة غير متوفرة الآن، قد تعود للعمل قريبا أم لا!
@endsection
@section('author')
GitHub
@endsection
...
<main class="flex justify-center items-center min-h-screen container flex-col md:flex-row m-auto text-center max-w-[1200px] px-2">
    <div class="w-[75%] md:w-1/2">
        <img src="{{ asset('') }}errors/image/503.svg" alt="خطء 503" class="w-full">
    </div>
    <div class="w-full md:w-1/2 mt-4 md:mt-0">
        <h2 class="text-yallow font-bold text-6xl">خطء 503</h2>
